...
\end{tabular}
\singlespacing
\caption[Logistic regression tuning results]{Logistic regression hyperparameter tuning results for each data set. Accuracy and AUC model statistics are split into train (in-sample) and test (out-of-sample) values.}
...
The cost function for a neural network takes on the form of a loss term and a complexity term (Ng, 2011b):
