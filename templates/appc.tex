...
PRD6 & Wrong-sized infrastructure & Likely & 3 & Over-estimation of accessible resource can and has led to over-building of surface facilities. For EGS, these extends to sustainable enthalpy levels (drawdown). \\ \hline
\end{tabular}}
...
DRL2 & Use ML to identify high gradient areas faster, shallower drilling & Low Likelihood & 2 & Focusing on high-gradient areas can reduce overall drill depths. Modeling could also target specific rock types to create a heat map of lithologic complexity or bedrock hardness to better inform the drillers. \\ \hline
...
PRD1 & Cost modeling for optimized spending and return & Medium & 3 & Cost models will not always be correct, and decisions may be made on the highside while reality follows the lowside. Nevertheless, early awareness of the scenario ranges enables mitigation behaviors earlier than otherwise true. \\ \hline
