...
\newacronym{enpv}{ENPV}{Expected Value of NPV}
\newacronym{fcn}{FCN}{Fully Connected Network}
\newacronym{fds}{FDS}{Full Data Set}
\newacronym{fn}{FN}{False Negative}
\newacronym{fp}{FP}{False Positive}
\newacronym{fpr}{FPR}{False Positive Rate}
\newacronym{gis}{GIS}{Geographic Information System}
\newacronym{gp}{GP}{Great Plains}
...
\newacronym{pnm}{PNM}{Public Service Company of New Mexico}
\newacronym{ppa}{PPA}{Power Purchase Agreement}
\newacronym{ppi}{PPI}{Producer Price Index}
...
\newacronym{sbr}{SBR}{Southern Basin and Range}
\newacronym{shap}{SHAP}{Shapley Additive Explanation}
\newacronym{sigt}{SiGT}{Silica Geothermometer Temperature}
\newacronym{steo}{STEO}{Short Term Energy Outlook}
\newacronym{tn}{TN}{True Negative}
\newacronym{tp}{TP}{True Positive}
\newacronym{tpr}{TPR}{True Positive Rate}
\newacronym{usgs}{USGS}{United States Geological Survey}
\newacronym{vag}{VAG}{Value at Gain}
\newacronym{var}{VAR}{Value at Risk}
\newacronym{wds}{WDS}{Well Data Set}
\newacronym{wds4}{WDS4}{Well Data Set plus 4}
\newacronym{wds8}{WDS8}{Well Data Set plus 8}
